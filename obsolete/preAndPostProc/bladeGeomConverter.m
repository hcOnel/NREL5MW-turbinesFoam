...
bladeGeomData=load("turbine1.blade1.qbSectionGeometry");
profilesFileID=fopen("turbine1.blade1.qbSectionProfiles");
bladeProfileNames=textscan(profilesFileID,'%s');
nQbladeSections=length(bladeGeomData(:,1));
fclose(profilesFileID);
...
fid = fopen("turbine1.blade1.tfSectionGeometry",'w');
